<template>
    <div >
         <article class="c_content" >
            ...
            <div class="cc_bottom">
                <p class="bottom_btn" ><span class="material-symbols-outlined">content_copy</span></p><!--@click="content_copy($event,item)"-->
...
import { reactive, ref,defineComponent } from "vue";
    ...
    export default defineComponent({//01,02,03... 순서가 있는것은 데이터에 
        ...
        methods:{
            changeTypeText(){
                let gg =this.itemData.qustion_type;
                if(gg == "ShortAnswer"){

                }else if(gg == "Long"){

                }else if(gg == "MultipleChoiceQuestions"){
